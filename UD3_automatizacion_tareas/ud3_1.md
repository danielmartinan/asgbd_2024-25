---
title: "UD3 - Automatización de tareas: Construcción de guiones de admin"
author: "Administración de sistemas gestores de bases de datos - ASIR"
date: "Curso 2024/25"
...
header-includes:
  - \usepackage{fancyhdr}
  - \pagestyle{fancy}
  - \fancyhead[L]{"Automatización de tareas - Construcción de guiones de admin"}
  ...
  - \usepackage{hyperref}
  - \hypersetup{unicode=true, pdfencoding=auto, psdextra}
---
...
Puedes encontrar la referencia de todos los posibles errores de mysql [aquí](https://dev.mysql.com/doc/mysql-errors/8.4/en/server-error-reference.html). También puedes encontrar un resumen con las condiciones más comunes en [este documento](./ud3_lista_errores_warnings_sql.md).
