...
- [5. Gestión de Errores y Condiciones (Handlers)](#5-gestión-de-errores-y-condiciones-handlers)
  ...
  - [5.4. `Get Condition` Statement](#54-get-condition-statement)
  - [**Sintaxis básica**](#sintaxis-básica)
  - [**Elementos de diagnóstico comunes**](#elementos-de-diagnóstico-comunes)
...
Puedes encontrar la referencia de todos los posibles errores de mysql [aquí](https://dev.mysql.com/doc/mysql-errors/8.4/en/server-error-reference.html).
