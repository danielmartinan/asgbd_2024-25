...
#### ¿Cómo puedo definir las condiciones?
...
- **Tipo de Acción**: especifica qué debe hacer MySQL cuando encuentra la condición:
...
- **Condición(es)**: puede especificarse de varias formas:
  - **Valor único**:
